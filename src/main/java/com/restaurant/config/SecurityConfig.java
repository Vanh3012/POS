    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/ingredients", "/ingredients/**")
                        .hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.PATCH, "/ingredients/{ingredientId}/stock")
                        .hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.POST, "/ingredients").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/ingredients/{ingredientId}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/ingredients/{ingredientId}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/history/**").authenticated()
